...
|---|---|
| DoR-A | `../../adapter/review_prompts/bible-readiness-review.md` |
| DoR-A の Kernel 部分のみ | `../../adapter/review_prompts/kernel-fill-review.md` |
| DoR-A の Bible facet 網羅 | `../../adapter/review_prompts/intake-coverage-review.md` |
| DoR-A の Update Proposal 検証 | `../../adapter/review_prompts/update-proposal-review.md` |
| DoR-A の contradiction 整理 | `../../adapter/review_prompts/contradiction-triage.md` |
| DoR-A の Bible 設計監査 | `../../adapter/review_prompts/design-audit-prompt.md` |
| DoR-A の Digest 自己 review | `../../adapter/review_prompts/intake-digest-review.md` |
...
6. **status は 12 値のいずれか、`-` や `?` で済まさない**（正本: `../status_vocabulary.md`）
...
- **判定 prompt 群**: `../../adapter/review_prompts/`
