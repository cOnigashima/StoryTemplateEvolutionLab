...
- `02_audit_gaps.md`: `../../adapter/review_prompts/design-audit-prompt.md` 連動
- `04_apply_to_new_work.md`: DoR-A v4 準拠
- `05_consistency_check.md`: `../../adapter/review_prompts/intake-coverage-review.md` 連動
...
| **支援 LLM が intake adapter 実行で hallucination** | bible に偽情報混入 | `../../adapter/review_prompts/intake-digest-review.md` を必ず通す |
...
- 検証 prompt: `../../adapter/review_prompts/`
