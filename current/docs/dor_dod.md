...
旧 v3 の DoR/DoD は archive に保存されています:
- `../../archive/2026-04-30-pre-v4/docs/dor_dod.md`

## 主な変更

- DoR-A の Bible Facet 完全性を 17 facet 体制に拡張
- Status 12 値 × DoR/DoD 通過可否表の追加
- 不満足時の戻し先（reverse flow）を表で明示
