...
`../../docs/domain/05_intake_coverage_checklist.md` の 86 項目を 1 つずつ機械的に確認し、`bible/` `design/` `state/` がどこまで埋まっているかを採点してください。
...
- `../../docs/domain/05_intake_coverage_checklist.md` — **本 prompt の中核根拠**
...
12 status 値ごとにカウント:
- filled / tentative / deferred / intentionally_blank / intentionally_hidden / not_applicable / genre_not_applicable / project_override / contradiction / needs_author_decision / missing / rejected
