...
6. `adapter/intake_adapter.md` で企画チャットを取り込み、`bible/design/state` を埋める。
...
8. `template/core/checklists/dor_dod.md` の **DoR-A** を満たしたら執筆開始（完全版 DoR は `proposal/2026-04-30-zero-base-v4/06_bible_dor.md`。※新構造対応の一本化は TODO、迷ったら checklists 版に従う）。
