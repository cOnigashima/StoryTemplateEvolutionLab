...
| `prompts/02_audit_gaps.md` | refactor | `07_review_prompts/design-audit-prompt.md` との連動を明記 |
| `prompts/03_extract_pattern.md` | keep | |
| `prompts/04_apply_to_new_work.md` | refactor | 新規 work bootstrap 手順を v4（DoR-A）に合わせて更新 |
| `prompts/05_consistency_check.md` | refactor | `07_review_prompts/intake-coverage-review.md` との連動を明記 |
