...
- `work_init/new_work_bootstrap.md` を読む（本 prompt の詳細手順）
...
`work_init/new_work_bootstrap.md` の Step 1〜14 に従う:
...
- `adapter/intake_adapter_prompt.md` を読み直す
- `adapter/writing_adapter_prompt.md` を読み直す
