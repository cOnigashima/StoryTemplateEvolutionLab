...
2. **Intake Adapter Prompt を経由する**（adapter/intake_adapter_prompt.md）
...
6. **status を必ず付ける**（11 値、docs/status_vocabulary.md）
...
- 11 status 値（filled / tentative / deferred / intentionally_blank / intentionally_hidden / not_applicable / project_override / contradiction / needs_author_decision / missing / rejected）→ `proposal/2026-04-30-zero-base-v4/02_domain_model.md` Section 12
- Intake Adapter prompt は v4 化済 → `current/adapter/intake_adapter_prompt.md`
