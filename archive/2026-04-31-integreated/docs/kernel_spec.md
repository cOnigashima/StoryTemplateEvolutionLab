...
> v3 履歴: `archive/2026-04-30-pre-v4/proposals/2026-04-29-domain-kernel-v3/04_kernel_spec.md`
...
- status 11 値の運用は維持（11 値は v3 から継承）
- Transformation Curve（Arc 同名衝突回避）を kernel #6 change_model.arc_shape の値域として整理

雛形: `current/templates/story/kernel.template.yaml`
