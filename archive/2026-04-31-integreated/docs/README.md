...
| `status_vocabulary.md` | 11 status / Judge 4 値 / Lock 5 状態 |
| `dor_dod.md` | Definition of Ready ／ Definition of Done（3 段ずつ） |
| `layer_facet_map.md` | Layer 0-4+R + Adapter 2 分割 |

これらは旧 Pack v3 (`../../story-template for TAKT/proposals/2026-04-29-domain-kernel-v3/`) を母体として、renji pilot で得た知見を反映したコンパクト版。詳細仕様が要るときは v3 docs を参照。
